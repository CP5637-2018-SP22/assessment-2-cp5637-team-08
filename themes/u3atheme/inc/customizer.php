 ...
 */
function u3atheme_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color', 
				array(
					'label'		=> __( 'Header and footer background color', 'u3atheme'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'u3atheme' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'u3atheme' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'u3atheme' )
		)
	);
	...
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'u3atheme_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'u3atheme_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'u3atheme' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'u3atheme' ),
				'full-content'	=> __( 'Full content', 'u3atheme' )
			),
...
add_action( 'customize_register', 'u3atheme_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function u3atheme_customize_preview_js() {
	wp_enqueue_script( 'u3atheme_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'u3atheme_customize_preview_js' );
...
function u3atheme_sanitize_length( $value ) {
...
if ( ! function_exists( 'u3atheme_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see u3atheme_custom_header_setup().
 */
function u3atheme_header_style() {
